...
require (
	...
	github.com/akeylesslabs/akeyless-go/v3 v3.3.6 // indirect
...
require (
	...
	k8s.io/apiextensions-apiserver v0.27.2 // indirect; indirec0
	k8s.io/client-go v0.27.2 // indirect; indirec0
