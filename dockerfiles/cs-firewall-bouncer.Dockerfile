...
# docker buildx build --push --platform linux/amd64,linux/arm64 -f cs-firewall-bouncer.Dockerfile -t ghcr.io/blesswinsamuel/infra-base/crowdsec-firewall-bouncer:latest .
