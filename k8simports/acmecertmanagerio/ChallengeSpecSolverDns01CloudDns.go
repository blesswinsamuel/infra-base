...
type ChallengeSpecSolverDns01CloudDns struct {
	...
	ServiceAccountSecretRef *ChallengeSpecSolverDns01CloudDnsServiceAccountSecretRef `field:"optional" json:"serviceAccountSecretRef" yaml:"serviceAccountSecretRef"`
}
