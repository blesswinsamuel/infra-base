...
type VaultDynamicSecretSpecProviderAuthKubernetes struct {
	...
	SecretRef *VaultDynamicSecretSpecProviderAuthKubernetesSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
	...
	ServiceAccountRef *VaultDynamicSecretSpecProviderAuthKubernetesServiceAccountRef `field:"optional" json:"serviceAccountRef" yaml:"serviceAccountRef"`
}
