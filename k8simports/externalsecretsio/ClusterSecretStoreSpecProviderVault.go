...
type ClusterSecretStoreSpecProviderVault struct {
	...
	Auth *ClusterSecretStoreSpecProviderVaultAuth `field:"required" json:"auth" yaml:"auth"`
	...
	CaProvider *ClusterSecretStoreSpecProviderVaultCaProvider `field:"optional" json:"caProvider" yaml:"caProvider"`
	...
	Version ClusterSecretStoreSpecProviderVaultVersion `field:"optional" json:"version" yaml:"version"`
}
