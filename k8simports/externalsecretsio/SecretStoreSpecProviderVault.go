...
type SecretStoreSpecProviderVault struct {
	...
	Auth *SecretStoreSpecProviderVaultAuth `field:"required" json:"auth" yaml:"auth"`
	...
	CaProvider *SecretStoreSpecProviderVaultCaProvider `field:"optional" json:"caProvider" yaml:"caProvider"`
	...
	Version SecretStoreSpecProviderVaultVersion `field:"optional" json:"version" yaml:"version"`
}
