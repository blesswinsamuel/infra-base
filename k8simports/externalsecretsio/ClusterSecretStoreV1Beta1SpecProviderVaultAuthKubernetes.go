...
type ClusterSecretStoreV1Beta1SpecProviderVaultAuthKubernetes struct {
	...
	SecretRef *ClusterSecretStoreV1Beta1SpecProviderVaultAuthKubernetesSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
	...
	ServiceAccountRef *ClusterSecretStoreV1Beta1SpecProviderVaultAuthKubernetesServiceAccountRef `field:"optional" json:"serviceAccountRef" yaml:"serviceAccountRef"`
}
