...
spec:
  ...
  - secretKey: PGUSER
    remoteRef: { key: doppler-secrets, property: POSTGRES_USERNAME }
---
apiVersion: external-secrets.io/v1beta1
kind: ExternalSecret
metadata:
...
spec:
  ...
  - secretKey: MINIO_ENDPOINT
    remoteRef: { key: doppler-secrets, property: S3_ENDPOINT }
  - secretKey: MINIO_ACCESS_KEY
    remoteRef: { key: doppler-secrets, property: S3_ACCESS_KEY }
  - secretKey: MINIO_SECRET_KEY
    remoteRef: { key: doppler-secrets, property: S3_SECRET_KEY }
---
apiVersion: v1
kind: ConfigMap
metadata:
