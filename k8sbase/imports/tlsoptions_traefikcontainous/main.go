package tlsoptions_traefikcontainous
...
func init() {
	_jsii_.RegisterClass(
		"tlsoptions_traefikcontainous.TlsOption",
	...
	_jsii_.RegisterStruct(
		"tlsoptions_traefikcontainous.TlsOptionProps",
		reflect.TypeOf((*TlsOptionProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"tlsoptions_traefikcontainous.TlsOptionSpec",
		reflect.TypeOf((*TlsOptionSpec)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"tlsoptions_traefikcontainous.TlsOptionSpecClientAuth",
		reflect.TypeOf((*TlsOptionSpecClientAuth)(nil)).Elem(),
	)
	_jsii_.RegisterEnum(
		"tlsoptions_traefikcontainous.TlsOptionSpecClientAuthClientAuthType",
