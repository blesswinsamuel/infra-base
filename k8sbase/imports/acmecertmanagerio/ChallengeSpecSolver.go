...
type ChallengeSpecSolver struct {
	...
	Dns01 *ChallengeSpecSolverDns01 `field:"optional" json:"dns01" yaml:"dns01"`
	...
	Http01 *ChallengeSpecSolverHttp01 `field:"optional" json:"http01" yaml:"http01"`
	...
	Selector *ChallengeSpecSolverSelector `field:"optional" json:"selector" yaml:"selector"`
}
