...
type VaultDynamicSecretSpecProviderAuthJwtKubernetesServiceAccountToken struct {
	...
	ServiceAccountRef *VaultDynamicSecretSpecProviderAuthJwtKubernetesServiceAccountTokenServiceAccountRef `field:"required" json:"serviceAccountRef" yaml:"serviceAccountRef"`
