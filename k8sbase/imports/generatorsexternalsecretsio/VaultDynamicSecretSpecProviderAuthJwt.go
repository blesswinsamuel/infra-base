...
type VaultDynamicSecretSpecProviderAuthJwt struct {
	...
	KubernetesServiceAccountToken *VaultDynamicSecretSpecProviderAuthJwtKubernetesServiceAccountToken `field:"optional" json:"kubernetesServiceAccountToken" yaml:"kubernetesServiceAccountToken"`
	...
	SecretRef *VaultDynamicSecretSpecProviderAuthJwtSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
