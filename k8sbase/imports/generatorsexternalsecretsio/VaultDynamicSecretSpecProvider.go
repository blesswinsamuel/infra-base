...
type VaultDynamicSecretSpecProvider struct {
	...
	Auth *VaultDynamicSecretSpecProviderAuth `field:"required" json:"auth" yaml:"auth"`
	...
	CaProvider *VaultDynamicSecretSpecProviderCaProvider `field:"optional" json:"caProvider" yaml:"caProvider"`
	...
	Version VaultDynamicSecretSpecProviderVersion `field:"optional" json:"version" yaml:"version"`
}
