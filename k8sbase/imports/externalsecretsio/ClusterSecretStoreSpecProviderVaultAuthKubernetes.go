...
type ClusterSecretStoreSpecProviderVaultAuthKubernetes struct {
	...
	SecretRef *ClusterSecretStoreSpecProviderVaultAuthKubernetesSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
	...
	ServiceAccountRef *ClusterSecretStoreSpecProviderVaultAuthKubernetesServiceAccountRef `field:"optional" json:"serviceAccountRef" yaml:"serviceAccountRef"`
}
