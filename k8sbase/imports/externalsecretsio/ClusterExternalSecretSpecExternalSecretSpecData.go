...
type ClusterExternalSecretSpecExternalSecretSpecData struct {
	// RemoteRef points to the remote secret and defines which secret (version/property/..) to fetch.
	RemoteRef *ClusterExternalSecretSpecExternalSecretSpecDataRemoteRef `field:"required" json:"remoteRef" yaml:"remoteRef"`
	...
	SourceRef *ClusterExternalSecretSpecExternalSecretSpecDataSourceRef `field:"optional" json:"sourceRef" yaml:"sourceRef"`
}
