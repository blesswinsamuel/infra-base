...
type ClusterSecretStoreSpecProviderWebhook struct {
	// Result formatting.
	Result *ClusterSecretStoreSpecProviderWebhookResult `field:"required" json:"result" yaml:"result"`
	// Webhook url to call.
	...
	CaProvider *ClusterSecretStoreSpecProviderWebhookCaProvider `field:"optional" json:"caProvider" yaml:"caProvider"`
	// Headers.
	...
	Secrets *[]*ClusterSecretStoreSpecProviderWebhookSecrets `field:"optional" json:"secrets" yaml:"secrets"`
	// Timeout.
