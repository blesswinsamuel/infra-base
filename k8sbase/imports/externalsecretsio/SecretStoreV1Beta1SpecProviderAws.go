...
type SecretStoreV1Beta1SpecProviderAws struct {
	// AWS Region to be used for the provider.
	Region *string `field:"required" json:"region" yaml:"region"`
	// Service defines which service should be used to fetch the secrets.
	Service SecretStoreV1Beta1SpecProviderAwsService `field:"required" json:"service" yaml:"service"`
	...
	Auth *SecretStoreV1Beta1SpecProviderAwsAuth `field:"optional" json:"auth" yaml:"auth"`
