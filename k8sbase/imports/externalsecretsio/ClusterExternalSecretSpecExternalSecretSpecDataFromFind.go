...
type ClusterExternalSecretSpecExternalSecretSpecDataFromFind struct {
	...
	Name *ClusterExternalSecretSpecExternalSecretSpecDataFromFindName `field:"optional" json:"name" yaml:"name"`
