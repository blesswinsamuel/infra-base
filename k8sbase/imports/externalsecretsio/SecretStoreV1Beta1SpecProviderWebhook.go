...
type SecretStoreV1Beta1SpecProviderWebhook struct {
	// Result formatting.
	Result *SecretStoreV1Beta1SpecProviderWebhookResult `field:"required" json:"result" yaml:"result"`
	// Webhook url to call.
	...
	CaProvider *SecretStoreV1Beta1SpecProviderWebhookCaProvider `field:"optional" json:"caProvider" yaml:"caProvider"`
	// Headers.
	...
	Secrets *[]*SecretStoreV1Beta1SpecProviderWebhookSecrets `field:"optional" json:"secrets" yaml:"secrets"`
	// Timeout.
