...
type SecretStoreV1Beta1SpecProviderVaultAuthAppRole struct {
	...
	SecretRef *SecretStoreV1Beta1SpecProviderVaultAuthAppRoleSecretRef `field:"required" json:"secretRef" yaml:"secretRef"`
}
