...
type SecretStoreSpecProviderAkeylessAuthSecretRefKubernetesAuth struct {
	...
	SecretRef *SecretStoreSpecProviderAkeylessAuthSecretRefKubernetesAuthSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
	...
	ServiceAccountRef *SecretStoreSpecProviderAkeylessAuthSecretRefKubernetesAuthServiceAccountRef `field:"optional" json:"serviceAccountRef" yaml:"serviceAccountRef"`
}
