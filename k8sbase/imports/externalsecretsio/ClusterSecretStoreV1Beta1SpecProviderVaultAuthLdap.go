...
type ClusterSecretStoreV1Beta1SpecProviderVaultAuthLdap struct {
	...
	SecretRef *ClusterSecretStoreV1Beta1SpecProviderVaultAuthLdapSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
