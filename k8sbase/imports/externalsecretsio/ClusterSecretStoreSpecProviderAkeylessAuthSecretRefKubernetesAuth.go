...
type ClusterSecretStoreSpecProviderAkeylessAuthSecretRefKubernetesAuth struct {
	...
	SecretRef *ClusterSecretStoreSpecProviderAkeylessAuthSecretRefKubernetesAuthSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
	...
	ServiceAccountRef *ClusterSecretStoreSpecProviderAkeylessAuthSecretRefKubernetesAuthServiceAccountRef `field:"optional" json:"serviceAccountRef" yaml:"serviceAccountRef"`
}
