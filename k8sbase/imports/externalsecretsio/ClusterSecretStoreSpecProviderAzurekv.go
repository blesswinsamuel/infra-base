...
type ClusterSecretStoreSpecProviderAzurekv struct {
	...
	AuthSecretRef *ClusterSecretStoreSpecProviderAzurekvAuthSecretRef `field:"optional" json:"authSecretRef" yaml:"authSecretRef"`
	...
	AuthType ClusterSecretStoreSpecProviderAzurekvAuthType `field:"optional" json:"authType" yaml:"authType"`
	...
	ServiceAccountRef *ClusterSecretStoreSpecProviderAzurekvServiceAccountRef `field:"optional" json:"serviceAccountRef" yaml:"serviceAccountRef"`
