...
type ClusterSecretStoreV1Beta1SpecProviderVaultAuthAppRole struct {
	...
	SecretRef *ClusterSecretStoreV1Beta1SpecProviderVaultAuthAppRoleSecretRef `field:"required" json:"secretRef" yaml:"secretRef"`
}
