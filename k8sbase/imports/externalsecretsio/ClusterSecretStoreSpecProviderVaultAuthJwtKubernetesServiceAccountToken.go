...
type ClusterSecretStoreSpecProviderVaultAuthJwtKubernetesServiceAccountToken struct {
	...
	ServiceAccountRef *ClusterSecretStoreSpecProviderVaultAuthJwtKubernetesServiceAccountTokenServiceAccountRef `field:"required" json:"serviceAccountRef" yaml:"serviceAccountRef"`
