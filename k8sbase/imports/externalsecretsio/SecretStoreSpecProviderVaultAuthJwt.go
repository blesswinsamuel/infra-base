...
type SecretStoreSpecProviderVaultAuthJwt struct {
	...
	KubernetesServiceAccountToken *SecretStoreSpecProviderVaultAuthJwtKubernetesServiceAccountToken `field:"optional" json:"kubernetesServiceAccountToken" yaml:"kubernetesServiceAccountToken"`
	...
	SecretRef *SecretStoreSpecProviderVaultAuthJwtSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
