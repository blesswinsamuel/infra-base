...
type ClusterSecretStoreV1Beta1SpecProviderWebhook struct {
	// Result formatting.
	Result *ClusterSecretStoreV1Beta1SpecProviderWebhookResult `field:"required" json:"result" yaml:"result"`
	// Webhook url to call.
	...
	CaProvider *ClusterSecretStoreV1Beta1SpecProviderWebhookCaProvider `field:"optional" json:"caProvider" yaml:"caProvider"`
	// Headers.
	...
	Secrets *[]*ClusterSecretStoreV1Beta1SpecProviderWebhookSecrets `field:"optional" json:"secrets" yaml:"secrets"`
	// Timeout.
