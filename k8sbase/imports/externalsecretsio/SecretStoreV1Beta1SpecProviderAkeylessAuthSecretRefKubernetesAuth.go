...
type SecretStoreV1Beta1SpecProviderAkeylessAuthSecretRefKubernetesAuth struct {
	...
	SecretRef *SecretStoreV1Beta1SpecProviderAkeylessAuthSecretRefKubernetesAuthSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
	...
	ServiceAccountRef *SecretStoreV1Beta1SpecProviderAkeylessAuthSecretRefKubernetesAuthServiceAccountRef `field:"optional" json:"serviceAccountRef" yaml:"serviceAccountRef"`
}
