...
type ClusterSecretStoreV1Beta1SpecProviderSenhasegura struct {
	// Auth defines parameters to authenticate in senhasegura.
	Auth *ClusterSecretStoreV1Beta1SpecProviderSenhaseguraAuth `field:"required" json:"auth" yaml:"auth"`
