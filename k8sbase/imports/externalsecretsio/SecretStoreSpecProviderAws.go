...
type SecretStoreSpecProviderAws struct {
	...
	Service SecretStoreSpecProviderAwsService `field:"required" json:"service" yaml:"service"`
	...
	Auth *SecretStoreSpecProviderAwsAuth `field:"optional" json:"auth" yaml:"auth"`
