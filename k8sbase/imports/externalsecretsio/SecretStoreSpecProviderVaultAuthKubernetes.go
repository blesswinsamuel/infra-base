...
type SecretStoreSpecProviderVaultAuthKubernetes struct {
	...
	SecretRef *SecretStoreSpecProviderVaultAuthKubernetesSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
	...
	ServiceAccountRef *SecretStoreSpecProviderVaultAuthKubernetesServiceAccountRef `field:"optional" json:"serviceAccountRef" yaml:"serviceAccountRef"`
}
