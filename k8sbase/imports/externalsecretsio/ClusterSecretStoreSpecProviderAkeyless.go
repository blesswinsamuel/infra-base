...
type ClusterSecretStoreSpecProviderAkeyless struct {
	...
	AuthSecretRef *ClusterSecretStoreSpecProviderAkeylessAuthSecretRef `field:"required" json:"authSecretRef" yaml:"authSecretRef"`
	...
	CaProvider *ClusterSecretStoreSpecProviderAkeylessCaProvider `field:"optional" json:"caProvider" yaml:"caProvider"`
}
