...
type ClusterSecretStoreV1Beta1SpecProviderVault struct {
	// Auth configures how secret-manager authenticates with the Vault server.
	Auth *ClusterSecretStoreV1Beta1SpecProviderVaultAuth `field:"required" json:"auth" yaml:"auth"`
	...
	CaProvider *ClusterSecretStoreV1Beta1SpecProviderVaultCaProvider `field:"optional" json:"caProvider" yaml:"caProvider"`
	...
	Version ClusterSecretStoreV1Beta1SpecProviderVaultVersion `field:"optional" json:"version" yaml:"version"`
}
