...
type SecretStoreV1Beta1SpecProviderAkeyless struct {
	// Akeyless GW API Url from which the secrets to be fetched from.
	AkeylessGwApiUrl *string `field:"required" json:"akeylessGwApiUrl" yaml:"akeylessGwApiUrl"`
	// Auth configures how the operator authenticates with Akeyless.
	AuthSecretRef *SecretStoreV1Beta1SpecProviderAkeylessAuthSecretRef `field:"required" json:"authSecretRef" yaml:"authSecretRef"`
	...
	CaProvider *SecretStoreV1Beta1SpecProviderAkeylessCaProvider `field:"optional" json:"caProvider" yaml:"caProvider"`
}
