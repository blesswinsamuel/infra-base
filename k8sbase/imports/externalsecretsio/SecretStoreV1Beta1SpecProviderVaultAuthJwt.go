...
type SecretStoreV1Beta1SpecProviderVaultAuthJwt struct {
	...
	KubernetesServiceAccountToken *SecretStoreV1Beta1SpecProviderVaultAuthJwtKubernetesServiceAccountToken `field:"optional" json:"kubernetesServiceAccountToken" yaml:"kubernetesServiceAccountToken"`
	...
	SecretRef *SecretStoreV1Beta1SpecProviderVaultAuthJwtSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
