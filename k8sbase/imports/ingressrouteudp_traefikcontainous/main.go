...
func init() {
	_jsii_.RegisterClass(
		"ingressrouteudp_traefikcontainous.IngressRouteUdp",
	...
	_jsii_.RegisterStruct(
		"ingressrouteudp_traefikcontainous.IngressRouteUdpProps",
		reflect.TypeOf((*IngressRouteUdpProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"ingressrouteudp_traefikcontainous.IngressRouteUdpSpec",
		reflect.TypeOf((*IngressRouteUdpSpec)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"ingressrouteudp_traefikcontainous.IngressRouteUdpSpecRoutes",
		reflect.TypeOf((*IngressRouteUdpSpecRoutes)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"ingressrouteudp_traefikcontainous.IngressRouteUdpSpecRoutesServices",
		reflect.TypeOf((*IngressRouteUdpSpecRoutesServices)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"ingressrouteudp_traefikcontainous.IngressRouteUdpSpecRoutesServicesPort",
