...
type ClusterIssuerSpecAcmeSolversHttp01IngressPodTemplate struct {
	...
	Metadata *ClusterIssuerSpecAcmeSolversHttp01IngressPodTemplateMetadata `field:"optional" json:"metadata" yaml:"metadata"`
	...
	Spec *ClusterIssuerSpecAcmeSolversHttp01IngressPodTemplateSpec `field:"optional" json:"spec" yaml:"spec"`
}
