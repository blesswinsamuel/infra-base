...
type IssuerSpecVault struct {
	...
	Auth *IssuerSpecVaultAuth `field:"required" json:"auth" yaml:"auth"`
	...
	CaBundleSecretRef *IssuerSpecVaultCaBundleSecretRef `field:"optional" json:"caBundleSecretRef" yaml:"caBundleSecretRef"`
