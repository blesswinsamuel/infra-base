...
type ClusterIssuerSpecVaultAuthKubernetes struct {
	...
	SecretRef *ClusterIssuerSpecVaultAuthKubernetesSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
	...
	ServiceAccountRef *ClusterIssuerSpecVaultAuthKubernetesServiceAccountRef `field:"optional" json:"serviceAccountRef" yaml:"serviceAccountRef"`
}
