...
type IssuerSpecAcmeSolversDns01Route53 struct {
	...
	AccessKeyIdSecretRef *IssuerSpecAcmeSolversDns01Route53AccessKeyIdSecretRef `field:"optional" json:"accessKeyIdSecretRef" yaml:"accessKeyIdSecretRef"`
	...
	SecretAccessKeySecretRef *IssuerSpecAcmeSolversDns01Route53SecretAccessKeySecretRef `field:"optional" json:"secretAccessKeySecretRef" yaml:"secretAccessKeySecretRef"`
}
