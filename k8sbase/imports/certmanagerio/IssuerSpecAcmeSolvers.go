...
type IssuerSpecAcmeSolvers struct {
	...
	Dns01 *IssuerSpecAcmeSolversDns01 `field:"optional" json:"dns01" yaml:"dns01"`
	...
	Http01 *IssuerSpecAcmeSolversHttp01 `field:"optional" json:"http01" yaml:"http01"`
	...
	Selector *IssuerSpecAcmeSolversSelector `field:"optional" json:"selector" yaml:"selector"`
}
