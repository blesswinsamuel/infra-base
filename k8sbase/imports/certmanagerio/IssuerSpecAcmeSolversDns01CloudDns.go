...
type IssuerSpecAcmeSolversDns01CloudDns struct {
	...
	ServiceAccountSecretRef *IssuerSpecAcmeSolversDns01CloudDnsServiceAccountSecretRef `field:"optional" json:"serviceAccountSecretRef" yaml:"serviceAccountSecretRef"`
}
