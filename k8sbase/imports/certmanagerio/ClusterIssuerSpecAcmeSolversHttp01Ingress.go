...
type ClusterIssuerSpecAcmeSolversHttp01Ingress struct {
	...
	IngressTemplate *ClusterIssuerSpecAcmeSolversHttp01IngressIngressTemplate `field:"optional" json:"ingressTemplate" yaml:"ingressTemplate"`
	...
	PodTemplate *ClusterIssuerSpecAcmeSolversHttp01IngressPodTemplate `field:"optional" json:"podTemplate" yaml:"podTemplate"`
