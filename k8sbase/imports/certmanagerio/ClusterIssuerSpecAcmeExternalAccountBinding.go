...
type ClusterIssuerSpecAcmeExternalAccountBinding struct {
	...
	KeySecretRef *ClusterIssuerSpecAcmeExternalAccountBindingKeySecretRef `field:"required" json:"keySecretRef" yaml:"keySecretRef"`
	...
	KeyAlgorithm ClusterIssuerSpecAcmeExternalAccountBindingKeyAlgorithm `field:"optional" json:"keyAlgorithm" yaml:"keyAlgorithm"`
}
