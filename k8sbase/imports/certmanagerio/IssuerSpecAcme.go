...
type IssuerSpecAcme struct {
	...
	PrivateKeySecretRef *IssuerSpecAcmePrivateKeySecretRef `field:"required" json:"privateKeySecretRef" yaml:"privateKeySecretRef"`
	...
	ExternalAccountBinding *IssuerSpecAcmeExternalAccountBinding `field:"optional" json:"externalAccountBinding" yaml:"externalAccountBinding"`
	...
	Solvers *[]*IssuerSpecAcmeSolvers `field:"optional" json:"solvers" yaml:"solvers"`
}
